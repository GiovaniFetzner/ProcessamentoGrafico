...
int setupGeometry()
{
    // Aqui setamos as coordenadas x, y e z dos pontos do octágono e as armazenamos de forma
    // sequencial, já visando mandar para o VBO (Vertex Buffer Objects)
    // O octágono é desenhado usando a equação paramétrica: x = cx + r*cos(theta), y = cy + r*sin(theta)
...
int main()
{
    ...
    GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Octagono", nullptr, nullptr);
    if (!window)
    {
