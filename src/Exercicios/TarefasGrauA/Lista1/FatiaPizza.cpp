...
const int PIZZA_SEGMENTS = 50; // Mais segmentos para suavidade
...
int setupGeometry()
{
    // Fatia de pizza: setor circular (ex: 60 graus)
    float cx = 0.0f, cy = 0.0f, r = 0.5f;
    float start_angle = 0.0f;                   // início da fatia
    float end_angle = 1.0f * 3.1415926f / 3.0f; // 60 graus (pi/3 rad)
    int n = PIZZA_SEGMENTS;
...
int main()
{
    ...
    // Gerando um buffer com a geometria de uma fatia de pizza
