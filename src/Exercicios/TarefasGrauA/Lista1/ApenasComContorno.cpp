...
int main()
{
    ...
    GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Poligono vazado!", nullptr, nullptr);
    if (!window)
    {
    ...
    while (!glfwWindowShouldClose(window))
    {
        // Este trecho de código é totalmente opcional: calcula e mostra a contagem do FPS na barra de título
        {
            ...
            if (title_countdown_s <= 0.0 && elapsed_s > 0.0)
            {
                ...
                char tmp[256];
                sprintf(tmp, "Poligono vazado! \tFPS %.2lf", fps);
        ...
        // Triângulo 1 - contorno verde claro
        glUniform4f(colorLoc, 0.6f, 1.0f, 0.6f, 1.0f);
        glDrawArrays(GL_LINE_LOOP, 0, 3);

        // Triângulo 2 - contorno cinza claro
